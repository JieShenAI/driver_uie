...
model_folder=/content/uie_output/${task_name}_${EXP_ID}_${model_name_log}_${decoding_format}_${data_name_log}_e${epoch}_${lr_scheduler}_lr${lr}_ls${label_smoothing}_b${batch_log}_wu${warmup_ratio}_n${negative}
